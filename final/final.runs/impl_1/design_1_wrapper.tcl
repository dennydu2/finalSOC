namespace eval ::optrace {
  variable script "B:/Classes/soc/finalSOC/final/final.runs/impl_1/design_1_wrapper.tcl"
...
set rc [catch {
  ...
  set_property webtalk.parent_dir B:/Classes/soc/finalSOC/final/final.cache/wt [current_project]
